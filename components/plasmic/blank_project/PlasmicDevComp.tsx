...
import sty from "./PlasmicDevComp.module.css"; // plasmic-import: q1LHpL7oK2/css

export type PlasmicDevComp__VariantMembers = {};
export type PlasmicDevComp__VariantsArgs = {};
type VariantPropType = keyof PlasmicDevComp__VariantsArgs;
export const PlasmicDevComp__VariantProps = new Array<VariantPropType>();

export type PlasmicDevComp__ArgsType = {};
type ArgPropType = keyof PlasmicDevComp__ArgsType;
export const PlasmicDevComp__ArgProps = new Array<ArgPropType>();

export type PlasmicDevComp__OverridesType = {
  root?: p.Flex<typeof LottieWrapper>;
};

export interface DefaultDevCompProps {
  className?: string;
}
...
function PlasmicDevComp__RenderFunc(props: {
  variants: PlasmicDevComp__VariantsArgs;
  args: PlasmicDevComp__ArgsType;
  overrides: PlasmicDevComp__OverridesType;
  forNode?: string;
}) {
...
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicDevComp__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicDevComp__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicDevComp__ArgProps,
          internalVariantPropNames: PlasmicDevComp__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicDevComp__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicDevComp";
  } else {
    func.displayName = `PlasmicDevComp.${nodeName}`;
  }
  return func;
}

export const PlasmicDevComp = Object.assign(
  // Top-level PlasmicDevComp renders the root element
  makeNodeComponent("root"),
  {
    // Helper components rendering sub-elements

    // Metadata about props expected for PlasmicDevComp
    internalVariantProps: PlasmicDevComp__VariantProps,
    internalArgProps: PlasmicDevComp__ArgProps
  }
);

export default PlasmicDevComp;
/* prettier-ignore-end */
